...
We used the model with the hyperparameter $\theta_i^*$, the intersection of the $\theta_i^*$, as the prediction function. The the hyperparameters tuned from model training are listed below:
